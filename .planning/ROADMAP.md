...
Plans:
- [x] 02-01-PLAN.md — Create checkpoint module and wire into costco.ts fetch loop with progress counter
- [ ] 02-02-PLAN.md — Add SIGINT/SIGTERM signal handling and completion summary to index.ts
...
| 2. Checkpoint and Resume | 1/2 | In Progress|  |
